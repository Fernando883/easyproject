...
public class Comentario implements Serializable {
    ...
    @JoinColumn(name = "ID_USUARIO", referencedColumnName = "ID_TAREA")
    @ManyToOne(optional = false)
    private Tarea idUsuario;
    ...
    public Tarea getIdUsuario() {
        return idUsuario;
    }

    public void setIdUsuario(Tarea idUsuario) {
    ...
    public String toString() {
        return "EasyProject.entity.Comentario[ idComent=" + idComent + " ]";
    }
