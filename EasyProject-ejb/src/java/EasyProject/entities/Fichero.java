...
public class Fichero implements Serializable {
    ...
    @Id
     @GeneratedValue(generator = "FICHERO_SEQUENCE")
    @SequenceGenerator(name="FICHERO_SEQUENCE",sequenceName="fich_seq",allocationSize=1)
    ...
    public String toString() {
        return "EasyProject.ejb.Fichero[ idFichero=" + idFichero + " ]";
    }
